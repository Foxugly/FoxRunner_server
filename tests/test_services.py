    ...
    def test_network_guard_checks_by_key(self):
        config = AppConfig(
            ...
            runtime=RuntimeConfig(
                ...
                heartbeat_file=Path("scheduler_heartbeat.json"),
                slots_file=Path("tests/fixtures/slots.json"),
                scenarios_file=Path("tests/fixtures/scenarios.json"),
    ...
    def test_scheduler_service_describe_plan_returns_payload(self):
        with TemporaryDirectory() as tmp:
            runtime = RuntimeConfig(
                ...
                heartbeat_file=Path(tmp) / "scheduler_heartbeat.json",
                slots_file=Path("tests/fixtures/slots.json"),
                scenarios_file=Path("tests/fixtures/scenarios.json"),
